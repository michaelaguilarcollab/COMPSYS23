...
Traditional HPC computing systems are provisioned with static fixed quantities of memory, storage, accelerators, and compute resources to compute application workloads.
