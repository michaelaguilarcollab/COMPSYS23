...
Some resources, within statically allocated Compute nodes, are allocated and not utilized.  

Some workloads are provided with resources in a given type that they do not need.  

Some workloads can require resources that they are not provided.   
