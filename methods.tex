...
The OFMF is based on a central management layer that exposes a RESTful API and leverages DMTF RF and SNIA SF schemas to enable infrastructure clients (e.g., users, management software, programming frameworks) tomanage composition of, and fabric configuration to computational resources. 
