...
The facility costs scale of large HPC systems, cooling and energy usage becomes more of an issue.  The percentage of power usage being used in Data Centers continues to grow.  Today, 4% of energy produced is used in data centers, up from 2% of energy usage was used in data centers, 2 years ago. \cite{dw} \cite{vmware} 
